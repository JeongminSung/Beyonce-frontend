...
const Mypage = () => {
  ...
  useEffect(() => {
    ...
    fetch("http://10.58.3.78:8000/user/profile", {
      method: "GET",
      headers: {
  ...
  //("http://10.58.3.78:8000/user/profile");
          ...
          <SideWrap>
            <AvatarContainer>
              <AvatarImg>
                ...
                {/*
                <img
                  src="https://a5.behance.net/925d33829716d3653f7c237b4fe208b8dd40c734/img/profile/no-image-115.png?cb=264615658"
                  srcset="https://a5.behance.net/925d33829716d3653f7c237b4fe208b8dd40c734/img/profile/no-image-50.png?cb=264615658 50w, https://a5.behance.net/925d33829716d3653f7c237b4fe208b8dd40c734/img/profile/no-image-115.png?cb=264615658 115w, https://a5.behance.net/925d33829716d3653f7c237b4fe208b8dd40c734/img/profile/no-image-138.png?cb=264615658 138w"
                  sizes="115px"
                  class="AvatarImage-avatarImage-3uu Avatar-root--Wh"
                />*/}
              </AvatarImg>
              <PlusContainer>
                <PlusIcon>
            ...
            <UserDetail>
              <Location>
                ...
                small room, 10th floor, WEWORK, Seolleung, Seoul, Korea, Earth,
            ...
            <EditBtnWrap>
              <EditBtn>
                <BtnLabel>
                  <Label for="file-upload">Add Work</Label>
                </BtnLabel>
              </EditBtn>
            </EditBtnWrap>
            <UserInfoWrap>
          ...
          <BoardWrap>
            ...
            <WorkWrap>
              ...
              <AddWorkWrap onClick={onClick}>
                <Portfolio>
                  <CreateHeading>
                    <CreateText>Create a Project</CreateText>
                  </CreateHeading>
                  <CreateFooter>
                    <FooterPara>
                      Get feedback, views, and appreciations. Public projects
...
const ProfileBanner = styled.div`
  ...
  transition: background-color 0.15s linear,
    height 0.65s cubic-bezier(0.19, 1, 0.22, 1);
  height: 210px;
  left: 0;
  position: absolute;
  right: 0;
